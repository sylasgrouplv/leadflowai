...
export function AppShell() {
  ...
  // adminOnly items (§39) are visible to platform admins only — never owners/employees.
  const nav = NAV.filter((item) => user?.role !== "employee" || !hideForEmployee.has(item.to)).filter(
